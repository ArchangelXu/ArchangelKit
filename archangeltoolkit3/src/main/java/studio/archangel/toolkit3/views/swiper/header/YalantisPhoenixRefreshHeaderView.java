package studio.archangel.toolkit3.views.swiper.header;
...
import studio.archangel.toolkit3.views.swiper.drawable.yalantis.BaseRefreshDrawable;
import studio.archangel.toolkit3.views.swiper.drawable.yalantis.SunRefreshDrawable;
...
public class YalantisPhoenixRefreshHeaderView extends FrameLayout implements SwipeTrigger, SwipeRefreshTrigger {
	...
	protected void onFinishInflate() {
		...
		mDrawable = new SunRefreshDrawable(getContext(), this, mTriggerOffset, AngelApplication.screen_width);
