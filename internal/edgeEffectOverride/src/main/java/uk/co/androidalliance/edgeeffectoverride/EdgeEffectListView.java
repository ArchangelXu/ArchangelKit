...
//      edgeEffectTop.setColor(Color.parseColor("#00000000"));
//
//      EdgeEffect edgeEffectBottom = new EdgeEffect(getContext());
//      edgeEffectBottom.setColor(Color.parseColor("#00000000"));
//
//      try {
