...
//    public MaterialMenuDrawable(Context context, int color, Stroke stroke, int icon_size, boolean no_padding) {
//        int transformDuration = DEFAULT_TRANSFORM_DURATION;
//        int pressedDuration = DEFAULT_PRESSED_DURATION;
...
//
//        this.stroke = stroke;
//        this.width = (int) (dpToPx(resources, icon_size) * scale);
//        this.height = (int) (dpToPx(resources, icon_size) * scale);
//        this.iconWidth = dpToPx(resources, icon_size) * scale;
